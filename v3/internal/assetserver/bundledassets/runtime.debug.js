...
function initDropTargets() {
  dropTargets = Array.from(document.querySelectorAll(`[style*="${CSS_DROP_PROPERTY}"]`)).filter((el) => getComputedStyle(el).getPropertyValue(CSS_DROP_PROPERTY).trim() === "drop").map((el) => ({
    element: el,
